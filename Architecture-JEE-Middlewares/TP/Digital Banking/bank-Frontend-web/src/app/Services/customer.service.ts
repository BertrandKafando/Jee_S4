...
export class CustomerService {
  ...
  public getcustomersAccounts(customer:Customer):Observable<Array<Account>>{

    return this.http.get <Account[]>(environment.host+"/customers/"+customer.id+"/bankAccounts")
}
